    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <td>Author</td>
                    <td><a href="<c:url value="/author/"/>${book.author.id}">${book.author.name}</a></td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="col-sm-8">
            ...
            <table class="reviews">
                <tr>
                    ...
                    <td><h3>Анастасия Кирилюк</h3>

                        <p>Чистой воды трешак. Ничего интересного или увлекательного я в этом не нахожу. И вообще в
                            нашей компании не приветствуется английский.</p></td>
                </tr>
                <tr>
                    <td><img src="http://cs421220.vk.me/v421220808/f96b/yiaJ2Aseexs.jpg"></td>
                    <td><h3>Сергей Рой</h3>

                        <p>Ну такое. ${book.origTitle} - я много слышал об этой книжке. Вот на курсах закончу с
                            спрингом, и прочту </p></td>
                </tr>
            </table>
        </div>
    </div>
