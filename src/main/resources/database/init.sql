...
(
  ...
  insert into book (origTitle, author_id, releaseYear, description) values ('The Physics of Superheroes', (select id_AUTHOR from author a where a.name = 'James Kakalios'), 2006, 'James Kakalios explores the scientific plausibility of the powers and feats of the most famous superheroes — and discovers that in many cases the comic writers got their science surprisingly right. Along the way he provides an engaging and witty commentary while introducing the lay reader to both classic and cutting-edge concepts in physics, including:<ul>
...
<li>Why physics professors gone bad are the most dangerous evil geniuses!</li></ul>');
  insert into book (origTitle, author_id, releaseYear, description) values ('Spring in Action Third Edition', (select id_AUTHOR from author a where a.name = 'Craig Walls'), 2011, 'Totally revised for Spring 3.0, this book is a hands-on guide to the Spring Framework. It covers the latest features, tools, and practices including Spring MVC, REST, Security, Web Flow, and more. Following short code snippets and an ongoing example developed throughout the book, you''ll learn how to build simple and efficient J2EE applications.');
  insert into book (origTitle, author_id, releaseYear, description) values ('OCA Java SE 7 Programmer I Certification Guide: Prepare for the 1ZO-803 exam', (select id_AUTHOR from author a where a.name = 'Mala Gupta'), 2011,
